...
package protocol URLQueryFragmentConvertible {
...
extension String: URLQueryFragmentConvertible {
    package init?(urlQueryFragmentValue value: URLQueryFragment) {
    ...
    package var urlQueryFragmentValue: URLQueryFragment {
