...
package enum URLQueryFragment: ExpressibleByStringLiteral, Equatable {
    ...
    package func asUrlDecoded() throws -> String {
        switch self {
    ...
    package static func == (lhs: URLQueryFragment, rhs: URLQueryFragment) -> Bool {
        do {
...
package struct URLEncodedFormData: ExpressibleByArrayLiteral, ExpressibleByStringLiteral, ExpressibleByDictionaryLiteral, Equatable {
    package var values: [URLQueryFragment]
    package var children: [String: URLEncodedFormData]
    let maxRecursionDepth = 100
    
    package var hasOnlyValues: Bool {
        return children.count == 0
    }
    
    package var allChildKeysAreSequentialIntegers: Bool {
    ...
    package init(values: [URLQueryFragment] = [], children: [String: URLEncodedFormData] = [:]) {
        self.values = values
    ...
    package init(arrayLiteral: String...) {
    ...
    package init(dictionaryLiteral: (String, URLEncodedFormData)...) {
        self.values = []
