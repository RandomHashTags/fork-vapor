    ...
    public struct Responder {
        ...
        final class Storage: Sendable {
            struct ResponderFactory {
                let factory: (@Sendable (Application) -> VaporHTTP.Responder)?
            }
        ...
        public var current: VaporHTTP.Responder {
        ...
        public var `default`: VaporHTTP.Responder {
            DefaultResponder(
        ...
        @preconcurrency public func use(_ factory: @Sendable @escaping (Application) -> (VaporHTTP.Responder)) {
