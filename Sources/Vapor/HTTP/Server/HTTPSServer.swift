...
public final class HTTPSServer: Server, Sendable {
    ...
    public struct Configuration: Sendable {
        var _configuration:HTTPServer.Configuration

        public static let defaultHostname = HTTPServer.Configuration.defaultHostname
        public static let defaultPort = HTTPServer.Configuration.defaultPort
        ...
        public var address: BindAddress {
            ...
            set {
                _configuration.address = newValue
            }
        }
        ...
        public var hostname: String {
            ...
            set {
                _configuration.hostname = newValue
            }
        }
        ...
        public var backlog: Int {
            ...
            set {
                _configuration.backlog = newValue
            }
        }
        ...
        public var reuseAddress: Bool {
            ...
            set {
                _configuration.reuseAddress = newValue
            }
        }
        ...
        public var tcpNoDelay: Bool {
            get {
                _configuration.tcpNoDelay
            }
            set {
                _configuration.tcpNoDelay = newValue
            }
        }

        /// Response compression configuration.
        public var responseCompression: HTTPServer.Configuration.ResponseCompressionConfiguration {
            get {
                _configuration.responseCompression
            }
            set {
                _configuration.responseCompression = newValue
            }
        }

        /// Request decompression configuration.
        public var requestDecompression: HTTPServer.Configuration.RequestDecompressionConfiguration {
            get {
                _configuration.requestDecompression
            }
            set {
                _configuration.requestDecompression = newValue
            }
        }
        ...
        public var supportPipelining: Bool {
            get {
                _configuration.supportPipelining
            }
            set {
                _configuration.supportPipelining = newValue
            }
        }
        
        public var supportVersions: Set<HTTPVersionMajor> {
            get {
                _configuration.supportVersions
            }
            set {
                _configuration.supportVersions = newValue
            }
        }
        ...
        public var serverName: String? {
            ...
            set {
                _configuration.serverName = newValue
            }
        }
        ...
        public var reportMetrics: Bool {
            get {
                _configuration.reportMetrics
            }
            set {
                _configuration.reportMetrics = newValue
            }
        }
        ...
        public var logger: Logger {
            ...
            set {
                _configuration.logger = newValue
            }
        }
        ...
        public var shutdownTimeout: TimeAmount {
            get {
                _configuration.shutdownTimeout
            }
            set {
                _configuration.shutdownTimeout = newValue
            }
        }
        ...
        public var connectionsPerServerTick: UInt {
            get {
                _configuration.connectionsPerServerTick
            }
            set {
                _configuration.connectionsPerServerTick = newValue
            }
        }
        ...
        public init(
            ...
            responseCompression: HTTPServer.Configuration.ResponseCompressionConfiguration = .disabled,
            requestDecompression: HTTPServer.Configuration.RequestDecompressionConfiguration = .enabled,
        ...
        public init(
            ...
            let supportedVersions:Set<HTTPVersionMajor>?
            if let supportVersions = supportVersions {
                supportedVersions = supportVersions
            } else {
                supportedVersions = tlsConfiguration == nil ? [.one] : [.one, .two]
            }
            _configuration = .init(
                address: address,
                backlog: backlog,
                ...
                serverName: serverName,
                reportMetrics: reportMetrics,
                logger: logger ?? Logger(label: "codes.vapor.http-server"),
                shutdownTimeout: shutdownTimeout,
                connectionsPerServerTick: connectionsPerServerTick
            )
    ...
    public var configuration: Configuration {
        ...
        set {
            ...
            self.application.storage[Application.HTTPS.Server.ConfigurationKey.self] = newValue
...
private final class HTTPServerConnection: Sendable {
    ...
    static func start(
        ...
        server: HTTPSServer,
        responder: Responder,
        configuration: HTTPSServer.Configuration,
